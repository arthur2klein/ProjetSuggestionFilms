    ...
    return FutureBuilder(
      ...
      builder: (
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (!snapshot.hasData) return const Text('No note');
          double? note = snapshot.data;
          String noteStr = note?.toString() ?? 'No note';
          return Text(noteStr);
        }
      },
    );
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text('Community note: ${movie.usernote}'),
                  ],
                ),
                FutureBuilder<bool>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Text(
                          'FutureBuilder Error when checking if viewed: $snapshot.error}');
                    } else {
